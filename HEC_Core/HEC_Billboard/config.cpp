...
class CfgVehicles
{
	...
	{
		scope=2;
		model="billboard\HEC_Billboard_1.p3d";
	};
	class HEC_Billboard_2: HouseNoDestruct
	{
		scope=2;
		model="billboard\HEC_Billboard_2.p3d";
	};
	class HEC_Billboard_3: HouseNoDestruct
	{
		scope=2;
		model="billboard\HEC_Billboard_3.p3d";
	};
	class HEC_Billboard_4: HouseNoDestruct
	{
		scope=2;
		model="billboard\HEC_Billboard_4.p3d";
	};
	class HEC_Billboard_5: HouseNoDestruct
	{
		scope=2;
		model="billboard\HEC_Billboard_5.p3d";
	};
};